...
png(filename ="plot1.png") #create png device for plot1

hist(dfRedux$Global_active_power,main="Global Active Power", xlab = "Global Active Power (kilowatts)", col="red",ylim=c(0,1200)) #the hist
